...
<p><br>
<span style="font-size:18px"><strong>Your Task:&nbsp;</strong>Your task is to complete the function <strong>swapBits</strong>() which takes an integer and <strong>returns an&nbsp;</strong>integer with all the odd and even bits swapped.</span></p>
