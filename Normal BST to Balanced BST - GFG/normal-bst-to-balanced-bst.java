...
class GfG
{
    ...
    Node constructBST(ArrayList<Integer>list,int i,int j){
        if(i>j){
            return null;
        }
        int mid= (i+j)/2;
        ...
        root.right=constructBST(list,mid+1,j);
        return root;
    }
    ...
    Node buildBalancedTree(Node root) 
    {
        ...
        getInorder(root,inorderArray);
        
        Node newroot = constructBST(inorderArray,0,inorderArray.size()-1);
        return newroot;
